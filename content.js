 ...
 },
 {
   ...
   rows: [
     ...
     },
     {
       ...
       en: [
         { text: "‘Below them, the Minamoto pressure on the front continues. Then the rear erupts. Shouting. Riders. Violence where there could be none. The sudden assault shocks the whole defensive system. Men must answer behind them while danger still presses in front." }
       ]
     },
     {
   ...
   rows: [
     {
       ...
       en: [
         { text: "‘This story, the answer to your question, dictates your responsibility. " }
       ]
     },
     {
