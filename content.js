...
/* =========================================================
 ...
 At the very end of the story, the reader may reveal the ten
 retrospective seals and return to KAMAE.
...
(() => {
 ...
 function enhanceAikiImprint(){
  ...
  seals.forEach((sealData,index) => {
   ...
   seal.innerHTML = `
    <span class="aiki-seal-stamp" aria-hidden="true">
     <span class="aiki-seal-jp">${sealData.jp}</span>
    </span>
    <span class="aiki-seal-copy" aria-hidden="true">
  ...
  storyRoot.appendChild(revealWrap);
  ...
  revealButton.addEventListener(
   ...
   () => {
    ...
    if(
     document.body.classList.contains("aiki-imprint-revealed")
    ){
     return;
    }
    ...
    const firstSeal =
     battleSection.querySelector(".aiki-seal-first");
 ...
 if(document.readyState === "loading"){
  ...
  requestAnimationFrame(enhanceAikiImprint);
 }
